#region Licence
// -----------------------------------------------------------------------
// <copyright file="CruncherSecuritySection.cs" company="James South">
...
namespace Cruncher.Config
{
    ...
    /// </summary>
    public class CruncherSecuritySection : ConfigurationSection
    {
        #region Properties
        /// <summary>
        ...
        /// <summary>
        /// Gets the <see cref="T:Cruncher.Config.CruncherSecuritySection.WhiteListElementCollection"/>.
        /// </summary>
        /// <value>The <see cref="T:Cruncher.Config.CruncherSecuritySection.WhiteListElementCollection"/>.</value>
