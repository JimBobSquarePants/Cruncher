...
namespace Cruncher
{
    ...
    public class JavaScriptCruncher : CruncherBase
    {
        ...
        /// </summary>
        private static readonly Regex ImportsRegex = new Regex(@"(?:@import\s*(url\([""']?)\s*(?<filename>.+\.js)(\s*[""']?)\s*\));", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.Multiline | RegexOptions.IgnorePatternWhitespace);
        #endregion
