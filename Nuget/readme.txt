...
It combines them, minifies them and caches them in the browser. Cruncher can handle nested css @import statements, re-maps relative resource urls and has a self cleaning cache 
should any changes be made to any of the referenced files.
  ...
  <cruncher>
    ...
    <security allowRemoteDownloads="true" maxBytes="524288" timeout="300000">
      ...
      <whiteList>
        ...
        <add token="iom" url="http://www.iom-world.org/css/style.css" />
      </whiteList>
    </security>
    <processing>
